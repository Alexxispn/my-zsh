...
# customiza colors in highlight
# Declare the variable
typeset -A ZSH_HIGHLIGHT_STYLES
# To differentiate aliases from other command types
ZSH_HIGHLIGHT_STYLES[alias]='fg=207'
# To have paths colored instead of underlined
ZSH_HIGHLIGHT_STYLES[path]='fg=220'
# To disable highlighting of globbing expressions
ZSH_HIGHLIGHT_STYLES[globbing]='none'
# To change all green color to:
ZSH_HIGHLIGHT_STYLES[precommand]='fg=230'
ZSH_HIGHLIGHT_STYLES[command]='fg=49'
ZSH_HIGHLIGHT_STYLES[arg0]='fg=49'

ZSH_HIGHLIGHT_STYLES[default]='fg=159'
